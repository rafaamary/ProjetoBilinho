  ...
  module V1
    class MatriculasController < ApplicationController
      ...
      def index
        ...
        render json: { status: 'Matrículas Carregadas!', message: 'Matrículas Carregadas!', data: matricula },
               status: :ok
      end
      ...
      def create
        ...
        if matricula.save
          render json: { status: 'Matricula Criada!', message: 'Matricula Criada!', data: matricula },
                 status: :ok
        else
          render json: { status: 'ERROR', message: 'Matricula não Criada!', data: matricula.errors },
      ...
      def matricula_params
        params.permit(:valor_total_curso, :quantidade_faturas, :dia_venc_fatura, :nome_curso, :instituicao_id,
                      :aluno_id)
      end
    end
  end
